...
export class LocalDsManager {
  ...
  static getProject(rootDir: string, filename): StandardDataSource {
  ...
  static saveProject(rootDir: string, filename, ds: StandardDataSource) {
    const projectPath = PontFileManager.getFilePath(rootDir, filename);
    PontFileManager.writeJson(projectPath, ds);
  }

  static isProjectExists(rootDir: string, project: Project) {
  ...
  /** 获取该项目最新的数据源 */
  static getLatestDsInProject(rootDir: string, project: Project): StandardDataSource {
  ...
  static appendRecord(rootDir: string, project: Project, ds: StandardDataSource) {
  ...
  static createProject(rootDir: string, project: Project) {
    const manifest = LocalDsManager.getProjectsManifest(rootDir);
  ...
  static saveDataSource(rootDir: string, project: Project, ds: StandardDataSource) {
  ...
  static getReportData(rootDir: string, project: Project) {
    const manifest = LocalDsManager.getProjectsManifest(rootDir);
  ...
  static openReport(rootDir: string, project: Project) {
